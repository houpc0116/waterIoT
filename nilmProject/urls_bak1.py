...
from water.views import waterPage, dispenserMap, peoplePage, GradePage, manageStudentPage, manageFacultyPage, statisticsDispenser, getDispenserInfo, showDispenserList, statisticsPeople, getAllStudentsData, insertStudentData, updateStudentData
